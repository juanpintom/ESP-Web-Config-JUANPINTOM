 ...
 //       server.on ( "/admin.html",     ESPreboot_html);
	...
	UDPNTPClient.begin(2390);  // Port for NTP receive
        ...
        if (config.NodeMode){
            ...
            //SetDynamicAddressing(); //if I use this esp halted on peer mode if 
                                      //it start as peer mode 
            //GetAddress();  
        }
        ...
        pinMode(BLINK, OUTPUT);                 // Use pin 2 as output
        pinMode(RELAY, OUTPUT);                 // Use pin 0 as output 
...
void loop ( void ) {
	...
	if (Refresh)  
	{
        ...
        // Here we start to play
              ...
              DigOut(RELAY, Souliss_T1n_Coil,MYLEDLOGIC);
              } 
